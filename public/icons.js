...
(function () {
  ...
  const P = {
    ...
    /* 眼睛关闭（密码隐藏态） */
    eyeOff: `<path d="M1.6 8S4 3.6 8 3.6 14.4 8 14.4 8 12 12.4 8 12.4 1.6 8 1.6 8z" ${S} opacity=".35"/><path d="M3 3l10 10" ${S}/><circle cx="8" cy="8" r="2" ${S} opacity=".35"/>`,
    /* 用户（登录用户名） */
    user: `<circle cx="8" cy="5.4" r="2.6" ${S}/><path d="M3.4 13c0-2.5 2-4 4.6-4s4.6 1.5 4.6 4" ${S}/>`,
    /* 分屏预览 */
